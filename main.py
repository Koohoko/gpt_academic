        ...
        with gr_L1():
            ...
            with gr_L2(scale=1, elem_id="gpt-panel"):
                ...
                with gr.Accordion("更换模型 & SysPrompt & 交互界面布局", open=(LAYOUT == "TOP-DOWN"), elem_id="interact-panel"):
                    ...
                    # max_length_sl = gr.Slider(minimum=256, maximum=32*1024, value=4096, step=1024, interactive=True, label="Local LLM MaxLength",)
                    max_length_sl = gr.Radio([2048,4096,8192,32768], value=8192, label="Local LLM MaxLength")
